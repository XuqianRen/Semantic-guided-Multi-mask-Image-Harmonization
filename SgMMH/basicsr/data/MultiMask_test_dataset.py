...
from basicsr.data.instgram import Perturb_Simulator
import random



@DATASET_REGISTRY.register()
class MultiMaskTestDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(MultiMaskTestDataset, self).__init__()
        self.opt = opt
