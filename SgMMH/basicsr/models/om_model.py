...
class OMModel(BaseModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        self.attention_mul = torch.cat([self.attention_mul_l,self.attention_mul_a,\
            self.attention_mul_b],axis=1)
        ...
        tmp_img = np.concatenate([tmp_real,tmp_comp, tmp_harm, tmp_add,  tmp_mask],1) 
