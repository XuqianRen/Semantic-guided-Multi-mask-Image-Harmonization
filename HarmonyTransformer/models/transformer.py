...
class TransformerEncoders(nn.Module):
    ...
    def __init__(self, d_model=256, nhead=8, num_encoder_layers=6, dim_feedforward=2048, dropout=0.0,
                 activation="relu", normalize_before=False,
                 return_intermediate_dec=False):
        super().__init__()
...
class TransformerDecodersMask(nn.Module):
    ...
    def forward(self, tgt, src_key_padding_mask=None, tgt_key_padding_mask=None, src_pos=None, tgt_pos=None):
        # flatten NxCxHxW to HWxNxC
        # bs, c, h, w = tgt.shape
        ...
        # tgt = tgt.flatten(2).permute(2, 0, 1)
        hs = self.decoder(tgt, memory_key_padding_mask=src_key_padding_mask, tgt_key_padding_mask=tgt_key_padding_mask,
