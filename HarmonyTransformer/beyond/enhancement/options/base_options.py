...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--patch_pos_nc', type=int, default=3, help='tr_r_enc_head')
        ...
        parser.add_argument('--tr_r_enc_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_r_enc_layers', type=int, default=6, help='tr_r_enc_head')
        parser.add_argument('--tr_r_dec_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_r_dec_layers', type=int, default=6, help='tr_r_enc_head')
        parser.add_argument('--tr_i_dec_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_i_dec_layers', type=int, default=6, help='tr_r_enc_head')
        parser.add_argument('--tr_l_enc_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_l_enc_layers', type=int, default=6, help='tr_r_enc_head')
        parser.add_argument('--tr_l_dec_head', type=int, default=2, help='tr_r_enc_head')
        ...
        parser.add_argument('--rec_type', type=str, default='linear', help='weight for L1 loss')
        parser.add_argument('--pos_none', action='store_true', help='global light only use trd')

        parser.add_argument('--nce_r', action='store_true', help="reflectance use nce(H,R)")
        parser.add_argument('--nce_i', action='store_true', help="illumination use nce(H,I)")
        parser.add_argument('--nce_r_distance_type', type=str, default='cov', help="reflectance use nce(H,R)")
        parser.add_argument('--nce_i_distance_type', type=str, default='dot', help="reflectance use nce(H,R)")
        parser.add_argument('--nce_layers', type=str, default='0,4,7', help='compute NCE loss on which layers')
